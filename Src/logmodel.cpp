...
QString LogModel::getLogLevelStr(int level) const
{
    switch (level) {
    default:
...
QVariant LogModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    ...
    if (role == Qt::SizeHintRole)
    {
        ...
        case 1: return QSize(levelWidth, defaultHeightForRow); // Level
        }
        return QVariant();
    }
...
void LogModel::insertLogItem(const AlgoSE::SystemLog& log)
{
